...
function hello_elementor_fail_load_admin_notice() {
	...
	if ( $is_elementor_installed ) {
		...
		$message = '<p>' . __( 'Hello theme is a lightweight starter theme designed to work perfectly with Elementor Page Builder plugin.', 'cercle-des-heros' ) . '</p>';

		$button_text = __( 'Activate Elementor Now', 'cercle-des-heros' );
		...
		$button_text = __( 'Install Elementor Now', 'cercle-des-heros' );
	...
	<div class="notice updated is-dismissible hello-elementor-notice hello-elementor-install-elementor">
		<div class="hello-elementor-notice-inner">
			...
			<div class="hello-elementor-notice-content">
				<h3><?php _e( 'Thank you for choosing Hello Theme!', 'cercle-des-heros' ); ?></h3>
				<p><?php echo $message; ?>
					<a href="https://go.elementor.com/hello-theme-learn/" target="_blank"><?php _e( 'Learn more about Elementor', 'cercle-des-heros' ); ?></a>.</p>
			</div>
